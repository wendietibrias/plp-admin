...
const CreateClassSchedule: React.FC = () => {
  ...
  const classScheduleFormFields: FormFieldComponent[] = [
    ...
    },
    {
      ...
      formItemProps: {
        ...
        initialValue: ScheduleStatus.ACTIVE,
  ...
  const handleFormSubmit = async () => {
    try {
      ...
      console.log("Payload Jadwal Kuliah Baru:", payload);
    ...
    <Content className="p-8 pb-10">
      ...
      <div className="mb-6">
        ...
        <Text className="text-sm! text-[#475467]!">
          Buat alokasi waktu perkuliahan baru, penugasan dosen pengampu, serta
          pemetaan ruang kelas.
        </Text>
      </div>
